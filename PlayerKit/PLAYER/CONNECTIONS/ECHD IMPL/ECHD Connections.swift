...
public struct DefaultServerAddresses {
 
 static let main = Self.setServerAddress()
 
  //  static let test = Self.setServerAddress()
 
 public static let mainPortal      = "https://echd.mos.ru"
 public static let stage60         = "https://stage60-echd.mos.ru"
 ...
 public static var serverPortal    =  mainPortal  //stage60
 
 static func setServerAddress() -> String { Self.serverPortal }
}

class NTXECHDManager: NSObject, NTXPlayerConnectionsManager {
...
// }()
 ...
 internal var sessionCookie: String {
  ...
  "grails_remember_me=\(credentials.token);"
 }
