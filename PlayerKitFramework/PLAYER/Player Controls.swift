...
internal enum NTXPlayerActions: String, Hashable, CaseIterable {
...
final internal class NTXDefaultPlayerButton<Player: NTXMobileNativePlayerProtocol> : UIButton, NTXPlayerControl {
 ...
 private func setSFSImages() {
  let img = UIImage(systemName: playerAction.imageName)?
   .applyingSymbolConfiguration(.init(pointSize: 35))?
   .withTintColor(.white)
